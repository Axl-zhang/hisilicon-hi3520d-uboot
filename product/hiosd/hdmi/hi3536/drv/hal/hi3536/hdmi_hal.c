...
HI_VOID HAL_HDMI_HardwareStatusGet(HDMI_HAL_S  *pstHdmiHal, HDMI_HARDWARE_STATUS_S* pstHwStatus)
{
    ...
    pstHwStatus->stScdcStatus.bSinkScrambleOn   = hwStatus.hdmiStatus.scdcStatus.bSinkScrambleOn;
    pstHwStatus->stScdcStatus.bSourceScrambleOn = hwStatus.hdmiStatus.scdcStatus.bSourceScrambleOn;
    pstHwStatus->stScdcStatus.u8TmdsBitClkRatio = hwStatus.hdmiStatus.scdcStatus.tmdsBitClkRatio;
}
...
HI_VOID HAL_HDMI_HotPlugStatusGet(HDMI_HAL_S *pstHdmiHal, HI_BOOL* bHotPlug)
{
    ...
    *bHotPlug = (hwStatus.hdmiStatus.hotPlug || hwStatus.hdmiStatus.rsen);
}
#endif

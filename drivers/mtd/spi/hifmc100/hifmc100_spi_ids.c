...
#define SET_WRITE_DUAL_ADDR(_dummy_, _size_, _clk_) \
	static struct spi_operation \
	write_dual_addr_##_dummy_##_size_##_clk_ = { SPI_IF_WRITE_DUAL_ADDR, \
...
#define SET_WRITE_QUAD_ADDR(_dummy_, _size_, _clk_) \
	static struct spi_operation \
	write_quad_addr_##_dummy_##_size_##_clk_ = { SPI_IF_WRITE_QUAD_ADDR, \
...
/*****************************************************************************/
struct spi_info hifmc100_spi_info_table[] = {

 ...
 *----------------------------------------------------------------------*/
#define CONFIG_FMC_SUPPORT

#ifdef CONFIG_FMC_SUPPORT
	#define CONFIG_HIFMC_SPI_NAND_SUPPORT
	#define CONFIG_HIFMC_SPI_NOR_SUPPORT

	#define CONFIG_HIFMC_REG_BASE_ADDRESS		FMC_REG_BASE
	#define CONFIG_HIFMC_BUFFER_BASE_ADDRESS	FMC_MEM_BASE
#endif /* CONFIG_FMC_SUPPORT */

#ifdef CONFIG_HIFMC_SPI_NOR_SUPPORT
	#define CONFIG_CMD_SF
	#define CONFIG_ENV_IS_IN_SPI_FLASH
	#define CONFIG_HIFMC100_CHIP_NUM		2
	#define CONFIG_SPI_NOR_8PIN_4X
#endif

#ifdef CONFIG_HIFMC_SPI_NAND_SUPPORT
...
#endif /* CONFIG_HIFMC100_SPI_NAND_SUPPORT */
